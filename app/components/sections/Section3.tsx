...
export default function Section3() {
    return (
        <section id="section3" className="py-24 pb-30 max-md:py-16 tracking-tighter bg-white">
            <div className="max-w-[1440px] mx-auto">
                ...
                <StaggerContainer className="grid grid-cols-2 gap-8 max-md:grid-cols-1 max-md:gap-6" staggerDelay={0.2} delay={0.4}>
                    <StaggerItem animation="fadeInUp">
                        <div className="bg-[url('/edu-1.webp')] flex items-end aspect-[7/5] bg-center bg-cover">
                            <MotionWrapper className="p-12 max-md:p-5 text-white" animation="fadeInUp" delay={0.3}>
