      ...
      <div className="w-full max-w-[1102px] flex flex-col gap-11 items-center mx-auto">
        ...
        <div className="flex flex-col gap-5 items-center">
          <div className="w-fit border flex items-center border-[#26E45C] bg-(--var(color-green-900)) rounded-full p-[5px] shadow-[0px_0px_8px_0px_rgba(0,0,0,0.05)]">
            <div className="px-5 py-3 bg-[#26E45C] cursor-pointer text-xl leading-[1.4] font-semibold text-black rounded-full">
              가맹점 예상 창업비용
            </div>
            <div className="px-5 py-3  cursor-pointer text-xl leading-[1.4] font-semibold text-[#FFFFFF80]  rounded-full">
              직영점 예상 창업비용
            </div>
          </div>
