    ...
    <section className="pt-[138px] pb-[170px] max-md:pt-[24px] max-md:pb-[60px] bg-[#090D09] bg-[url(/section6-bg.webp)] bg-cover">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="mt-[32px] max-md:mt-[14px]">
          <StaggerContainer
            className="grid grid-cols-4 max-lg:grid-cols-2 gap-4 max-md:gap-2.5 lg:h-[380px]"
            staggerDelay={0.1}
            delay={0.3}
          >
            <StaggerItem animation="scaleIn">
              <div className="flex flex-col gap-11 max-xl:gap-8 max-lg:gap-6 bg-[#0E0E0ECC] h-full items-center justify-center max-md:w-full max-lg:h-[280px] max-md:h-[184px] max-md:gap-[21px]">
                <img
                  src="/icon-1.svg"
                  alt="평균 고객 만족도"
                  className="w-[90px] max-md:w-[43px] max-xl:w-[76px]"
                />
                <div className="text-center ">
                  <h3 className="text-xl font-bold mt-2 tracking-[-0.4px] text-white max-xl:text-lg">
                    평균 고객 만족도
                  </h3>
            ...
            <StaggerItem animation="scaleIn">
              <div className="flex flex-col gap-11 max-xl:gap-8 max-lg:gap-6 bg-[#0E0E0ECC] h-full items-center justify-center max-md:w-full max-lg:h-[280px] max-md:h-[184px] max-md:gap-[21px]">
                ...
                <div className="text-center ">
                  ...
                  <p className="text-base leading-[1.4] text-[#eee] mt-2 tracking-tight max-xl:text-sm max-md:text-[11px]">
                    아뜰랑 맨즈헤어 원장 태원빠의 <br />
                    B급 감성 남성 뷰티 채널
                  </p>
                  <p className="font-poppins text-[60px] italic font-semibold text-[#26E45C] max-md:text-[30px] max-xl:text-[40px]">
