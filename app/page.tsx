    ...
    <div>
      ...
      <section className="relative flex flex-col items-center justify-center h-[600px] max-md:h-[656px] w-full text-center bg-[url('/hero.webp')]">
        <MotionWrapper animation="fadeIn" duration={1}>
          <h2 className="en text-xl max-md:text-[14px] text-white">
            Atlanc Premium Men&apos;s Hair Consulting
          </h2>
        </MotionWrapper>
        <MotionWrapper animation="fadeInUp" delay={0.3} duration={0.8}>
          <p className="mt-6 text-white text-[55px] max-md:text-[30px] font-bold leading-[1.3] tracking-[-2]">
            우리는 헤어를 <br className="md:hidden" />
            디자인하지 않습니다. <br />
            당신의 인상을 디자인합니다.
          </p>
        </MotionWrapper>
        ...
        <MotionWrapper
          ...
          delay={0.6}
        >
          <span className="num text-white text-xl font-medium tracking-wide mb-4">
            explore
          </span>
      ...
      <section className="bg-white h-[890px] max-md:h-[650px] max-md:pt-[60px] max-md:pb-[60px] overflow-hidden">
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-2 max-md:grid-cols-1 gap-16 max-md:gap-8 items-center h-[890px] max-md:h-auto">
            ...
            >
              <h2 className="en text-lg max-md:text-[16px] font-semibold text-[var(--color-primary-500)] mb-4">
                REVIEWS
              </h2>
              <h3 className="font-bold text-5xl max-md:text-[26px] leading-[1.3] tracking-[-1.5] mb-6">
                아뜰랑을 통해 <br />
                새로운 나의 모습을 발견한 <br />
                고객님들의 실시간 후기
              </h3>
              <a
                ...
                href="https://map.naver.com/p/entry/place/1547650412?placePath=/review"
                target="_blank"
              >
                리뷰 더보기 →
              </a>
...
계속 방문할 계획이에요."
      ...
      <section className="bg-[url('/welcome-bg.webp')] pt-32 pb-32 max-md:pt-[60px] max-md:pb-[60px]">
        <div className="max-w-[1440px] mx-auto">
          ...
          <MotionWrapper animation="fadeInUp" delay={0.2}>
            <p className="text-white font-bold text-center text-5xl max-md:text-[26px] leading-[1.3] mt-3 tracking-[-1.5]">
              아뜰랑 맨즈헤어 <br />
              대표원장이 직접 소개합니다.
            </p>
          </MotionWrapper>
      ...
      <section className="tracking-tight bg-white pt-35 pb-0 max-md:pt-[60px] max-md:pb-[60px]">
        <div className="max-w-[1440px] mx-auto">
          ...
          <MotionWrapper animation="fadeInUp" delay={0.2}>
            <p className="text-black font-bold text-center text-5xl max-md:text-[26px] leading-[1.3] mt-3">
              아뜰랑은 이렇게 다릅니다.
            </p>
          </MotionWrapper>
          <div className="mt-10">
            ...
            >
              <StaggerItem animation="fadeInUp">
                <a className="" href="#section1" style={{ cursor: "pointer" }}>
                  <div className="group flex flex-col max-md:flex-row max-md:items-center max-md:gap-8 p-[32px] bg-[var(--color-gray-50)] hover:bg-black transition-colors duration-300">
                    <p className="num font-semibold text-6xl text-[var(--color-gray-300)] group-hover:text-[var(--color-gray-700)]">
                      01
                    </p>
                    <div>
                      <h3 className="text-2xl font-semibold mt-2 mb-10 max-md:mb-4 text-black group-hover:text-white">
                        데이터 기반 컨설팅 시스템
                      </h3>
                      <div className="group-hover:text-[var(--color-primary-500)]">
                        <span className="mr-2 font-semibold">자세히</span>
                        <span>
      ...
      <section className="tracking-tight bg-black bg-[url('/location-bg.webp')] pt-35 pb-35 max-md:pt-[60px] max-md:pb-[60px]">
        <div className="max-w-[1440px] mx-auto">
          ...
          <MotionWrapper animation="fadeInUp" delay={0.2}>
            <p className="text-white font-bold text-center text-5xl max-md:text-[26px] leading-[1.3] mt-3">
              아뜰랑의 각 지점에 대해 <br />
              궁금하신가요?
            </p>
          </MotionWrapper>
          <div className="mt-10">
            <StaggerContainer
              className="grid grid-cols-3 max-md:grid-cols-1 gap-8 max-md:gap-12"
              staggerDelay={0.15}
              delay={0.3}
            >
              <StaggerItem animation="fadeInUp">
                <div>
                  ...
                  />
                  <p className="mt-4 font-semibold text-[var(--color-primary-500)]">
                    1호점
                  </p>
                  ...
                  <p className="mt-1">
                    <span className="mr-2 text-white">영업시간</span>
                    <span className="text-[var(--color-extended-gray-400)]">
